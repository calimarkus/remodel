...
function formattedStringValueForIvarWithFormatSpecifier(iVarString:string, stringFormatSpecifier:string):string {
  return "[NSString stringWithFormat:@\"" + stringFormatSpecifier + "\", " + iVarString + "]";
}
...
function objectValueForAttribute(attribute:ObjectSpec.Attribute):string {
  ...
  return ObjCTypeUtils.matchType({
    ...
    NSInteger: function() {
      return formattedStringValueForIvarWithFormatSpecifier(iVarString, "%zd");
    },
    NSUInteger: function() {
      return formattedStringValueForIvarWithFormatSpecifier(iVarString, "%tu");
    },
    double: function() {
